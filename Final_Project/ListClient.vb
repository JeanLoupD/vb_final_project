Public Class ListClient
    ...
    'When window load
    Private Sub ListClient_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'Disabling the list client menu button
        clientListMenu.Enabled = False

        'Calling the function to populate the data grid view list
        client_db_connection.ShowAllClients(clients)
